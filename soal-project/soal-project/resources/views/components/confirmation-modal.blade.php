    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah kamu yakin ingin menghapus data Artis ini?</h3>
                <form class="space-y-6"
                    action="{{ route('artis.delete', ['kd_artis'=>$data->kd_artis]) }}"
                    method="post"
                >
                    @csrf
                    @method('delete')
